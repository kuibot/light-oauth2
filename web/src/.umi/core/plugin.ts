...
import * as Plugin_0 from 'D:/codespace/learn/light-oauth2/web/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/codespace/learn/light-oauth2/web/src/app.tsx',
    },
    {
      apply: Plugin_1,
